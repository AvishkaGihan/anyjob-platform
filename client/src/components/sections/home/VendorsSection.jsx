    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div
                    className={`mb-16 text-center transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                ...
                <div
                    className={`mt-16 text-center transition-all duration-1000 delay-500 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                    <Link
                        to="/vendors"
