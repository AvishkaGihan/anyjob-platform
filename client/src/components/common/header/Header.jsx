    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span
            className={`text-xl font-bold transition-colors duration-300 ${scrolled ? "text-prussian-blue-500" : "text-white"
              }`}
          >
            AnyJob Refactor
          </span>
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <div className="flex gap-3">
            <Link
              to="/login"
              className={`px-4 py-2 rounded-lg transition-all duration-300 hover:shadow-md ${scrolled
        ...
        {/* Mobile Menu Button */}
        <button
          className={`lg:hidden p-2 transition-colors duration-300 ${scrolled ? "text-prussian-blue-500" : "text-white"
            }`}
        ...
        >
          <div className="w-6 flex flex-col gap-1.5 items-end">
            <span
              className={`block h-0.5 rounded transition-all duration-300 ${mobileMenuOpen
